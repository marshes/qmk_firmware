 ...
 */
 ...
 [_COLEMAK] = LAYOUT( \
  ...
  KC_LSFT,         KC_Z,   KC_X,    KC_C,    KC_D,    KC_V, TD(X_MEDIA),       KC_LBRC,  KC_K,    KC_H,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT, \
                              KC_LALT, KC_LGUI, TT(_LOWER), KC_SPC, KC_ENT, RAISE, KC_BSPC, KC_DEL \
),
...
[_RAISE] = LAYOUT( \
  _______,   KC_F11, _______,    _______, _______, _______,                         _______,   _______, _______, _______,       _______, _______, \
   KC_GRV,   QWERTY,    KC_2,       KC_3,    KC_4,    KC_5,                            KC_6,      KC_7,   KC_UP,    KC_9,       KC_PGUP, _______, \
  _______,  _______, _______,    _______, _______, _______,                      A(KC_LEFT),   KC_LEFT, KC_DOWN, KC_RGHT,    A(KC_RGHT), XXXXXXX, \
  _______,  _______, _______,    COLEMAK, _______, _______,  _______, S(KC_MINS),   KC_MINS, S(KC_EQL),  KC_EQL, S(KC_MINS), S(KC_BSLS), KC_BSLS, \
...
void oled_task_user(void) {
  if (is_keyboard_master()) {
    ...
    switch (get_highest_layer(default_layer_state)) {
        case _QWERTY:
            oled_write_ln_P(PSTR("Layout: QWERTY"), false);
            break;
        case _COLEMAK:
            oled_write_ln_P(PSTR("Layout: Colemak"), false);
            break;
        default:
...
//    oled_write_ln_P(PSTR("LAYER"), false);
    switch (get_highest_layer(layer_state)) {
        ...
        case _ADJUST:
            ...
            break;
        default:
            oled_write_ln_P(PSTR("Layer: Undef\n"), false);
    }
